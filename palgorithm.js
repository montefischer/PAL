...
// b.csv is the .csv file exported by Google Forms. Put it in the same directory as newpal.js
...
require('fs').createReadStream('b.csv').pipe(converter);
